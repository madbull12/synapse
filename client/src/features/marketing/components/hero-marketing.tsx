    ...
    <div className="relative min-h-screen overflow-hidden bg-black">
      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto mt-12 px-4 text-center">
          ...
          >
            Powered by a lightweight Go backend and WebSockets. Experience
            ultra-low latency communication, end-to-end security, and seamless
            concurrency.
          </motion.p>
          ...
          >
            ...
            <img
              ...
              alt="Synapse Chat Interface Preview"
