/**
 * Zepa UI — supaste-navbar
 * https://zepa.design/components/supaste-navbar
...
const NAV_ITEMS = ["Features", "FAQ", "Pricing", "About"];
  ...
  return (
    ...
    <>
      ...
      <div className="w-full flex justify-center flex-shrink-0 px-4 md:px-0">
        <div
          className="sticky top-0 z-50 w-full max-w-3xl flex-shrink-0"
          style={{
            ...
            <ul className="flex items-center gap-0.5">
              {NAV_ITEMS.map((item) => (
                <li key={item}>
                  <a
                    href="#"
                    className="px-4 py-1.5 text-[14px] text-white/55 hover:text-white/90 transition-colors duration-150 rounded-full whitespace-nowrap"
                  >
                    {item}
                  </a>
                </li>
    ...
    //       A curated collection of production-ready UI components crafted for the
    //       modern web — open source and free.
    //     </p>
    //     <Link
    //       href="/components"
    //       className="bg-black/25 backdrop-blur-sm border border-white/20 text-white px-6 py-3 rounded-full text-sm font-medium hover:bg-black/35 transition-colors duration-150"
    //     >
    //       Browse Components
    //     </Link>
    //   </div>
...
export const __demoId = "9cb682b1fba6";
